...
function WidgetStatCard({ stats }: StatsCardProps) {
  return (
    <div className="bg-slate-300 flex flex-col py-2 px-4 mt-2">
      ...
      <div className="flex justify-between my-2">
        <p className="text-base">{stats.homeCorners ? stats.homeCorners : 0}</p>
        <p className="text-base">Corners</p>
        <p className="text-base">{stats.awayCorners ? stats.awayCorners : 0}</p>
      </div>
    </div>
  );
}
