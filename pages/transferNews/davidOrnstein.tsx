...
import getDavidTweets from "../../lib/twitter/davidOrnstein/getTweets";
import { Tweet } from "../../typings";

interface DavidProps {
  tweets: Tweet[];
}

function davidOrnstein({ tweets }: DavidProps) {
  return (
    <Default>
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  const tweets = await getDavidTweets();
  return {
    props: {
      tweets,
    },
